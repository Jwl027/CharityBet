  		...
  		if (firebaseUser) {
            ...
            ref.child('requests').once('value',snap=>{
                ...
                //RIght
				 ...
				 var $divButton = $("<div>", {"class": "rButtonDiv", "id": "rButtonDiv" + i});
				 ...
				 var $button1 = $("<div>", {"class": "button1", "id": "button1"+i});
				 var $button2 = $("<div>", {"class": "button2", "id": "button1"+2});
